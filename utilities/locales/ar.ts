export default {
  translation: {
    ...
    dataStatus: {
      loading: "جاري التحميل...",
      notesMainText: "لا يوجد ملاحظات!",
      notesText: "يمكنك البدء بإضافة ملاحظات الآن",
      usersMainText: "قائمة الاتصال فارغة!",
      usersText: "يمكنك البدء بالتواصل مع مستخدمين آخرين",
      notificationMainText: "لاإشعارات الآن!",
      notificationText: "أنت على علم بالمستجدات",
      remindersPatientMainText: "لا يوجد ملاحظات الآن!",
      remindersPatientText: "سيصلك إشعار في حالة وجود ملاحظة جديدة",
      remindersSupervisorMainText: "لا يوجد ملاحظات!",
      remindersSupervisorText: "يمكنك البدء بإضافة ملاحظات الآن",
      sentInvitationsMainText: "لا يوجد طلبات مرسلة",
      sentInvitationsText: "يمكنك البدء بإرسال طلبات اتصال الآن",
      receivedInvitationsMainText: "لم يصلك طلبات اتصال حتى الآن",
      receivedInvitationsText: "سيصلك إشعار في حالة وجود طلب اتصال",
    },
    mailIsVerified: {
