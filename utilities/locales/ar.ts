export default {
  translation: {
    ...
    notifications: {
      ...
      REJECTED_CONNECTION:
        "لقد م رفض طلب الاتصال خالص بك, يمكنك إعادة الإرسال مرة أخرى بعد أسبوع",
      ACCEPTED_CONNECTION:
        "لقد تم قبول طلب الاتصال الخص بك, يمكنك الآن بدء التواصل",
      NEW_UPDATE: "يمكنك الآن تحميل التحديث الخاص بنا من موقعك المفضل",
      RECEIVED_NEW_REMINDER:
        "لقد تم إرسال ملاحظة جديدة لك, يمكنك معرفة المزيد من التفاصيل من خلال ملاحظات الطبيب",
      UNHEALTHY_PATIENT:
        "المعلومات الصحية الخاصة بمريضك مختلفة عن المعدلات الطبيعية, نحن نوصي بالتواصل مع المريض ومتابعة حالته",
      CONNECTIONS: "تواصل",
      APP_NEWS: "تحديثات",
